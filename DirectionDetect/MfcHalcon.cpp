...
unsigned int __stdcall gWorkThreadFun(PVOID pM)
{
	...
	*/
	...
	SetFramegrabberParam(hv_AcqHandle, "Height", 4080);
	SetFramegrabberParam(hv_AcqHandle, "AcquisitionMode", "SingleFrame");
	SetFramegrabberParam(hv_AcqHandle, "AcquisitionLineRate", 760);
	SetFramegrabberParam(hv_AcqHandle, "ExposureTime", 150.0);
	SetFramegrabberParam(hv_AcqHandle, "grab_timeout", 7000);
